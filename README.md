...
Once the `conda-forge` channel has been enabled, `plantuml` can be installed with:

```
conda install plantuml
```

It is possible to list all of the versions of `plantuml` available on your platform with:
